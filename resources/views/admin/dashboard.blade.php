    ...
    <div class="mt-8 bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        ...
        @else
            <div class="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                Branding fields are waiting for the latest database migration. Run <span class="font-semibold">php artisan migrate</span>, then refresh this page.
            </div>
        @endif
    </div>
@endsection
